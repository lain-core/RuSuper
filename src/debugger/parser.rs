...
fn collect_args(argvec: Vec<&str>) -> Result<Vec<TokenSeparator>, InvalidDbgArgError> {
...
fn validate_tag_offsets(
    ...
    let mut result_tokens: Vec<TokenSeparator> = vec![];
